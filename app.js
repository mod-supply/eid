...
const TEMPLATES = [
  {
    ...
    fb: 'tf1',
    label: 'قالب ١',
    text: { x: 0.5, y: 0.78, fs: 96, color: '#ffffff' }
  },
  {
    id: 2,
    src: 'designs/t2.png',
    fb: 'tf2',
    label: 'قالب ٢',
    text: { x: 0.5, y: 0.65, fs: 88, color: '#F5E3C8' }
  },
  {
    id: 3,
    src: 'designs/t3.png',
    fb: 'tf3',
    label: 'قالب ٣',
    text: { x: 0.5, y: 0.82, fs: 100, color: '#ffffff' }
  }
];
...
/* ── Draw name with auto font-size ── */
function drawName(ctx, name, cfg) {
  let fontSize = cfg.fs;
  const maxWidth = CANVAS_W * 0.82;
